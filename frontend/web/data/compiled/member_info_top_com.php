...
<div id="res_block">
<form id="goadded" class="content-form margin-bottom" name="form" action="member.php?act=com_top" method="post" autocomplete="off" style='margin-bottom: 10px!important;'>
<?php if($CFG[info_top_gold]) { ?>
<h2 class="zagalovok">
<div data-content="member.php?act=com" id="back" class="goback" style="width: 40px;    margin: -2px 0px 0px 0px;"><i class="icon-reply"></i></div>   
Поднятие в топ компании <span class="dar">Доступно топовых суток: <span class="st"><?php echo $user_info['gold'];?></span></span></h2>
<span class="marg5">Компания будет отображаться в случайном порядке на главной странице в блоке 'Наши компании'.</span>
<span class="marg5">По истечении срока оплаченной услуги, Ваша компания будет удалена из блока 'Наши компании', и будет отображаться согласно правилам сортировки</span>
...
<input type="submit" id="submit" name="submit" class="button_nulik" value="Поднять" style="margin: 20px 0px 0px 0px;" />
<?php } else { ?>
